...
ModuleWrapper **
mw_children(const ModuleWrapper *mw_module, size_t *n_children) {
    const auto module = static_cast<torch::jit::script::Module *>(mw_module->module);
    ...
    *n_children = children.size();
    ...
    for (const auto &child: children) {
        ...
        childModule->module = new torch::jit::script::Module(child); // this is done to ensure deep copy
...
*mw_pickle(const ModuleWrapper *model) {
    torch::jit::script::Module *module = static_cast<torch::jit::script::Module *>(model->module);
