...
# under test/avito/workloads/dump/ (gitignored scratch), so host-side tooling
# (TabPFN env) can read them without a live DB connection (host psql access is
# blocked by pg_hba). The committed unit-test fixture is test/avito/w_task_1.csv;
# point the test at a fresh dump with
# NEURDB_TASK_CSV=test/avito/workloads/dump/w_task_<h>.csv.
...
CONTAINER_OUT=/code/neurdb-dev/test/avito/workloads/dump
HOST_OUT=/home/worker/r/neurdb/neurdb-dev/test/avito/workloads/dump
