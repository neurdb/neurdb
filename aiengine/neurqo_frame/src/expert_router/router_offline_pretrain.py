...
if __name__ == "__main__":
    ...
    parser.add_argument(
        ...
        type=float,
        default=0.02,
        help="Threshold for filtering data (the label arounds)",
    )
    parser.add_argument(
    ...
    parser.add_argument(
        ...
        type=int,
        default=256,
        help="Embedding dimension size, same as train_pretrain_embedding2.py",
    )
    parser.add_argument(
        "--num_self_attn_layers", type=int, default=2, help="num_self_attn_layers"
    )
    ...
    parser.add_argument(
        "--gamma", type=float, default=0.5, help="Gamma for the learning rate scheduler"
    )
    parser.add_argument(
        "--alpha", type=float, default=0.5, help="Balance classificaiton and regression"
    )
    parser.add_argument(
        "--loss_gamma",
        type=float,
        default=2,
        help="A higher gamma in focal loss focuses more on hard-to-classify examples",
    )
