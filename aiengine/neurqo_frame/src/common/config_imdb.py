...
class IMDBConfig(BaseConfig):
    ...
    TRAIN_TEST_ONLINE_CONVARIATE = (
        "./experiment_result/datasets/workload_data_train_test_online_mix_convariate"
    )
    ...
    def load_sql_query(query_ident: str) -> str:
        ...
        filepath = os.path.join(
            IMDBConfig.QUERY_DIR, "join-order-benchmark", sql_filename
        )
