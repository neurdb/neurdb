 ...
 * @see https://www.postgresql.org/docs/16/spi-spi-execute-plan.html for the
 * SPI_execute_plan API call
 * @param {SpiConnection *} conn - the SPI connection
 ...
 * @details: this is done before the query is executed, to protect against SQL
 * injection
