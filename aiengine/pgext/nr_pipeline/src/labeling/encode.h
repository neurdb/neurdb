...
/**
 * Encode a text, look up the mapping table and encode the text if the mapping exists.
 * Otherwise, add a new mapping to the table and encode the text
...
/**
 * Encode a column, this function will create a char*-to-int mapping table for the column
 * @param table_name char* The table containing the column to be encoded
 * @param column_name char* The column to be encoded
